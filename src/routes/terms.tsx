...
function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" effectiveDate="August 9, 2026">
      <p>
      ...
      <h2 className="text-xl font-semibold">4. Connected Google services</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold">6. AI-generated content is not guaranteed to be accurate</h2>
      <p>
        Lumin AI is an AI system and can make mistakes, including factual errors or incomplete
        explanations. Lumin AI is a study aid, not a substitute for instruction from your
        teachers, and you should verify important information independently, especially before
        relying on it for graded work.
      </p>
      ...
      <p>
        ...
        Lumin AI, you grant us the limited right to process your messages solely to provide the
      ...
      <p>
        ...
        academic consequences resulting from your use of Lumin AI or reliance on AI-generated
        content.
      </p>
