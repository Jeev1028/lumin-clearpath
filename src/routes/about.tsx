...
function AboutPage() {
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-deep">
      {/* Ambient background, same glow-orb treatment as the rest of the
          site (see styles.css) -- gives this page its own backdrop instead
          of sitting on a flat color. */}
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden" aria-hidden>
        <div className="glow-orb absolute top-1/3 -left-24 h-[34rem] w-[34rem] -translate-y-1/2 opacity-60" />
        <div className="glow-orb absolute -right-24 bottom-0 h-96 w-96 opacity-30" />
      </div>
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 items-center px-6 py-12">
        <div className="grid w-full items-center gap-12 lg:grid-cols-[1.15fr_1fr]">
          ...
          <div className="lumin-md max-h-[65vh] overflow-y-auto rounded-3xl border border-border/70 bg-card/70 p-6 text-sm leading-relaxed text-foreground/90 shadow-panel backdrop-blur-sm sm:p-8 sm:text-base">
            <p>
            ...
            <p>
              ClearPath is a calm study platform: a place to track tests and assignments, lay out a
              class schedule, and work with Lumin AI, a study companion that actually behaves like a
              tutor rather than a ghostwriter.
            </p>
            ...
            <p>
              ...
              produce an essay, a lab report, or a ready-to-submit outline, and it won't hand you a
              finished answer to a math problem or a name for your school project. Instead, it walks
              you through the method or the way to think about it, so the thinking stays yours. You
              can read the full detail of how it's expected to behave in our{" "}
